...
This fork automatically optionally fetches new versions on launch, if you check the AutoUpdateListLocally under options. It will prompt you to login into a microsoft account. I will not be trying to merge this into the [original repo](https://github.com/MCMrARM/mc-w10-version-launcher) as the solution is too messy in my opinion. Also thanks to the [GDK Links Repo](https://github.com/MinecraftBedrockArchiver/GdkLinks) where I got the version link getter code from, which I slightly modified.
