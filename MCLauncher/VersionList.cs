...
namespace MCLauncher
{
    public class VersionList : ObservableCollection<WPFDataTypes.Version>
    {
        ...
        public VersionList(string cacheFileUWP, string importedDirectory, string versionsApiUWP, WPFDataTypes.ICommonVersionCommands commands, PropertyChangedEventHandler versionPropertyChangedEventHandler, string cacheFileGDK, string versionsApiGDK, Preferences userPrefs)
        {
